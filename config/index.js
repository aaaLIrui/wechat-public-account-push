export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx85eaf80fc8383aaf",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "1a05a0a86d04b5908162f85018b11c20000",
  ...
  USERS: [
    {
      ...
      id: "otS0q60CE_HjNHHq10OdSCg5uDuE"，
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "DTYH3NRNCrbpHwkhgD_8KKrjhrI0HWkZYjOTK9SRUcc	",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "洛阳",
